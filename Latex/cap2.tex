...
\begin{comment}
    \indent
    \par Este capítulo detalha toda revisão literária aplicada ao projeto,  abordando assim conceitos teóricos, tecnologias e contexto histórico.
\end{comment}
