...
\begin{document}
    ...
    \pretextual
		...
		\include{cap1} \cleardoublepage  % quando usa twoside
		\include{cap2} \cleardoublepage
		\include{cap3} \cleardoublepage
		\include{cap4} \cleardoublepage
		\include{cap5} \cleardoublepage
