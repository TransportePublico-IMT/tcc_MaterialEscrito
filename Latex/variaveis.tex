...
% palavras-chave
\newcommand{\PalavraChaveA}{dados}
\newcommand{\PalavraChaveB}{dashboard}
\newcommand{\PalavraChaveC}{inteligência}
\newcommand{\PalavraChaveD}{analytics}
\newcommand{\PalavraChaveE}{decisão}
\newcommand{\PalavraChaveF}{ônibus}

% key-words
\newcommand{\KeyWordA}{data}
\newcommand{\KeyWordB}{dashboard}
\newcommand{\KeyWordC}{monitoring}
\newcommand{\KeyWordD}{training}
\newcommand{\KeyWordE}{transport}
\newcommand{\KeyWordF}{problem}
